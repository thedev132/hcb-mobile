...
HCB Mobile is a React Native Expo application made in typescript for Hack Club Bank, supporting iOS, Android, and web platforms. It connects to the HCB v4 API and provides mobile banking functionality for Hack Club organizations.
