...
function CardPage(props) {
    ...
    var _j = (0, swr_1.default)(grantId ? "card_grants/".concat(grantId) : null).data, grantCard = _j === void 0 ? _card : _j;
    ...
    var _k = (0, swr_1.default)("cards/".concat(id), {
    ...
    }), card = _k.data, cardFetchError = _k.error;
    ...
    var _l = (0, useStripeCardDetails_1.default)(id), details = _l.details, toggleDetailsRevealed = _l.toggle, detailsRevealed = _l.revealed, detailsLoading = _l.loading;
    ...
    var _m = (0, react_1.useState)(false), refreshing = _m[0], setRefreshing = _m[1];
    var _o = (0, react_1.useState)(null), cardError = _o[0], setCardError = _o[1];
    var _p = (0, react_1.useState)(null), transactionError = _p[0], setTransactionError = _p[1];
    var _q = (0, react_1.useState)(false), cardExpanded = _q[0], setCardExpanded = _q[1];
    var fadeAnim = (0, react_1.useState)(new react_native_1.Animated.Value(0))[0];
    var _r = (0, react_1.useState)(false), isUpdatingStatus = _r[0], setIsUpdatingStatus = _r[1];
    var skeletonAnim = (0, react_1.useRef)(new react_native_1.Animated.Value(0)).current;
    var _s = (0, react_1.useState)(false), errorDisplayReady = _s[0], setErrorDisplayReady = _s[1];
    var _t = (0, react_1.useState)(false), showActivateModal = _t[0], setShowActivateModal = _t[1];
    var _u = (0, react_1.useState)(false), showTopupModal = _u[0], setShowTopupModal = _u[1];
    var _v = (0, react_1.useState)(false), showPurposeModal = _v[0], setShowPurposeModal = _v[1];
    var _w = (0, react_1.useState)(""), purposeText = _w[0], setPurposeText = _w[1];
    var _x = (0, react_1.useState)(false), isSettingPurpose = _x[0], setIsSettingPurpose = _x[1];
    var _y = (0, react_1.useState)(false), isOneTimeUse = _y[0], setIsOneTimeUse = _y[1];
    var _z = (0, react_1.useState)(""), topupAmount = _z[0], setTopupAmount = _z[1];
    var _0 = (0, react_1.useState)(false), isToppingUp = _0[0], setIsToppingUp = _0[1];
    var _1 = (0, react_1.useState)(""), last4 = _1[0], setLast4 = _1[1];
    var _2 = (0, react_1.useState)(false), activating = _2[0], setActivating = _2[1];
    var _3 = (0, react_1.useState)(), pattern = _3[0], setPattern = _3[1];
    var _4 = (0, react_1.useState)(), patternDimensions = _4[0], setPatternDimensions = _4[1];
    var _5 = (0, react_1.useState)(""), cardName = _5[0], setCardName = _5[1];
    var _6 = (0, react_1.useState)(false), isBurningCard = _6[0], setIsBurningCard = _6[1];
    ...
    var _7 = (0, swr_1.default)("cards/".concat(id, "/transactions")), transactionsData = _7.data, transactionsLoading = _7.isLoading, transactionsError = _7.error;
    ...
    var _8 = (0, react_1.useState)(false), cardLoaded = _8[0], setCardLoaded = _8[1];
    ...
    var onRefresh = (0, react_1.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    _a.sent();
                    return [4 /*yield*/, mutate("card_grants/".concat(grantId))];
                case 4:
                    _a.sent();
                    setCardError(null);
                    setTransactionError(null);
    ...
    }); }, [mutate, card === null || card === void 0 ? void 0 : card.id, id, grantId]);
    ...
    var _9 = (0, react_1.useState)(false), cardDetailsLoading = _9[0], setCardDetailsLoading = _9[1];
    var _10 = (0, react_1.useState)(false), isReturningGrant = _10[0], setisReturningGrant = _10[1];
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (isNaN(amount) || amount <= 0) {
                        (0, alertUtils_1.showAlert)("Invalid Amount", "Please enter a valid amount greater than 0.");
                        return [2 /*return*/];
                    }
                    setIsToppingUp(true);
                    _a.label = 1;
                case 1:
                    ...
                    return [4 /*yield*/, hcb.post("cards/".concat(card.id, "/topup"), {
                ...
                case 2:
                    ...
                    mutate("cards/".concat(card.id));
                    mutate("user/cards");
                    Haptics.notificationAsync(Haptics.NotificationFeedbackType.Success);
                    return [3 /*break*/, 5];
                case 3:
                    error_2 = _a.sent();
                    (0, errorUtils_1.logCriticalError)("Topup error", error_2, {
                        cardId: card.id,
                        amount: topupAmount,
                    });
                    (0, alertUtils_1.showAlert)("Error", "Failed to top up card. Please try again.");
                    Haptics.notificationAsync(Haptics.NotificationFeedbackType.Error);
                    return [3 /*break*/, 5];
                case 4:
    ...
    var handleSetPurpose = function () { return __awaiter(_this, void 0, void 0, function () {
        var error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.trys.push([1, 3, 4, 5]);
                    return [4 /*yield*/, hcb.patch("card_grants/".concat(grantId), {
                ...
                case 2:
                    ...
                    mutate("cards/".concat(card.id));
                    mutate("grant_cards/".concat(grantId));
                    mutate("user/cards");
                    Haptics.notificationAsync(Haptics.NotificationFeedbackType.Success);
                    return [3 /*break*/, 5];
                case 3:
                    error_3 = _a.sent();
                    (0, errorUtils_1.logCriticalError)("Set purpose error", error_3, {
                        cardId: card.id,
                        purpose: purposeText,
                    });
                    (0, alertUtils_1.showAlert)("Error", "Failed to set purpose. Please try again.");
                    Haptics.notificationAsync(Haptics.NotificationFeedbackType.Error);
                    return [3 /*break*/, 5];
                case 4:
    ...
    var handleOneTimeUse = function () { return __awaiter(_this, void 0, void 0, function () {
        var error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 2:
                    _a.sent();
                    mutate("card_grants/".concat(grantId));
                    mutate("user/cards");
                    Haptics.notificationAsync(Haptics.NotificationFeedbackType.Success);
                ...
                case 3:
                    error_4 = _a.sent();
                    (0, errorUtils_1.logCriticalError)("One time use error", error_4, {
                        cardId: (card === null || card === void 0 ? void 0 : card.id) || (grantCard === null || grantCard === void 0 ? void 0 : grantCard.card_id),
                    });
                    (0, alertUtils_1.showAlert)("Error", "Failed to set one time use. Please try again.");
                    Haptics.notificationAsync(Haptics.NotificationFeedbackType.Error);
                    return [3 /*break*/, 5];
                case 4:
    ...
    var handleBurnCard = function () { return __awaiter(_this, void 0, void 0, function () {
        var error_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    _a.trys.push([1, 3, 4, 5]);
                    return [4 /*yield*/, hcb.post("cards/".concat(card.id, "/cancel"))];
                case 2:
                    _a.sent();
                    mutate("cards/".concat(card.id));
                    mutate("user/cards");
                ...
                case 3:
                    error_5 = _a.sent();
                    (0, errorUtils_1.logCriticalError)("Burn card error", error_5, { cardId: card.id });
                    (0, alertUtils_1.showAlert)("Error", "Failed to burn card. Please try again.");
                    Haptics.notificationAsync(Haptics.NotificationFeedbackType.Error);
                    return [3 /*break*/, 5];
                case 4:
    ...
    function getCardActionButtons() {
        ...
        if (isGrantCard && isManagerOrAdmin && canTopupCard(card)) {
            buttons.push((0, jsx_runtime_1.jsx)(Button_1.default, { style: {
                    ...
                    borderTopWidth: 0,
                    borderRadius: 12,
                }, color: "white", iconColor: "white", icon: "plus", onPress: function () { return setShowTopupModal(true); }, children: "Topup" }, "topup"));
        }
        ...
        // Add one time button
        if (isGrantCard && isManagerOrAdmin) {
            buttons.push((0, jsx_runtime_1.jsx)(Button_1.default, { icon: "private", style: {
                    backgroundColor: "#415E84",
                }, onPress: handleOneTimeUse, loading: isOneTimeUse, children: "One time use" }, "one-time"));
        }
        if (isGrantCard && isManagerOrAdmin) {
            buttons.push((0, jsx_runtime_1.jsx)(Button_1.default, { icon: "edit", color: "#114F3D", style: {
                    backgroundColor: "#50ECC0",
                }, onPress: function () {
                    setPurposeText("");
                    setShowPurposeModal(true);
                }, children: "Set purpose" }, "edit-purpose"));
        }
        // Add grant button
        ...
        if ((isManagerOrAdmin || isCardholder) && !isGrantCard) {
            buttons.push((0, jsx_runtime_1.jsx)(Button_1.default, { icon: "fire", style: { backgroundColor: "#D0152D" }, onPress: handleBurnCard, loading: isBurningCard, children: "Burn card" }, "fire"));
        }
        if (buttons.length === 0)
            return null;
        var rows = [];
                    ...
                    paddingBottom: tabBarHeight + 20,
                        ...
                        marginBottom: 20,
                                ...
                                backgroundColor: themeColors.card,
                                        ...
                                        marginBottom: 12,
                                                ...
                                                (detailsRevealed && !details) ? ((0, jsx_runtime_1.jsx)(react_native_1.Animated.View, { style: createSkeletonStyle(50, 22) })) : ((0, jsx_runtime_1.jsx)(react_native_1.Text, { style: {
                                                    ...
                                                    fontWeight: "500",
                                                    fontFamily: "JetBrains Mono",
                                                }, selectable: detailsRevealed && details ? true : false, children: detailsRevealed && details ? details.cvc : "•••" })) })] }), isGrantCard && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(Divider_1.default, {}), (0, jsx_runtime_1.jsxs)(react_native_1.View, { children: [((_g = grantCard === null || grantCard === void 0 ? void 0 : grantCard.user) === null || _g === void 0 ? void 0 : _g.email) && !isCardholder && ((0, jsx_runtime_1.jsxs)(react_native_1.View, { style: {
                                                        flexDirection: "row",
                                                        justifyContent: "space-between",
                                                        marginBottom: 12,
                                                    }, children: [(0, jsx_runtime_1.jsx)(react_native_1.Text, { style: {
                                                                ...
                                                                fontWeight: "500",
                                                                fontFamily: "JetBrains Mono",
                                                            }, onPress: function () { var _a; return Linking.openURL("mailto:".concat((_a = grantCard === null || grantCard === void 0 ? void 0 : grantCard.user) === null || _a === void 0 ? void 0 : _a.email)); }, children: (_h = grantCard === null || grantCard === void 0 ? void 0 : grantCard.user) === null || _h === void 0 ? void 0 : _h.email })] })), (0, jsx_runtime_1.jsxs)(react_native_1.View, { style: {
                                                        flexDirection: "row",
                                                        justifyContent: "space-between",
                                                        marginBottom: 12,
                                                        flexWrap: "wrap",
                                                                ...
                                                                fontWeight: "500",
                                                                fontFamily: "JetBrains Mono",
                                                            }, children: (0, util_1.formatMerchantNames)(grantCard === null || grantCard === void 0 ? void 0 : grantCard.allowed_merchants) })] }), (0, jsx_runtime_1.jsxs)(react_native_1.View, { style: {
                                                        flexDirection: "row",
                                                        justifyContent: "space-between",
                                                        marginBottom: 12,
                                                        flexWrap: "wrap",
                                                                ...
                                                                fontWeight: "500",
                                                                fontFamily: "JetBrains Mono",
                                                            }, children: (0, util_1.formatCategoryNames)(grantCard === null || grantCard === void 0 ? void 0 : grantCard.allowed_categories) })] }), (grantCard === null || grantCard === void 0 ? void 0 : grantCard.purpose) && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(react_native_1.Text, { style: {
                                                                fontSize: 16,
                                                                color: themeColors.text,
                                                                flexShrink: 1,
                                                                ...
                                                                fontWeight: "500",
                                                                fontFamily: "JetBrains Mono",
                                                            }, children: grantCard === null || grantCard === void 0 ? void 0 : grantCard.purpose })] }))] }), (0, jsx_runtime_1.jsxs)(react_native_1.View, { style: {
                                                flexDirection: "row",
                                                justifyContent: "space-between",
                                                marginBottom: 12,
                                            }, children: [(0, jsx_runtime_1.jsx)(react_native_1.Text, { style: {
                                                        ...
                                                        fontWeight: "500",
                                                        fontFamily: "JetBrains Mono",
                                                    }, children: (grantCard === null || grantCard === void 0 ? void 0 : grantCard.one_time_use) ? "Yes" : "No" })] })] }))] }), (0, jsx_runtime_1.jsxs)(react_native_1.View, { style: {
                                flexDirection: "row",
                                justifyContent: "space-between",
                                alignItems: "center",
                                marginBottom: 15,
                                ...
                                return ((0, jsx_runtime_1.jsx)(react_native_1.TouchableOpacity, { onPress: function () {
                                    ...
                                    ], children: (0, jsx_runtime_1.jsx)(Transaction_1.default, { transaction: transaction, showMerchantIcon: true, top: index == 0, bottom: index == transactions.length - 1, hideAvatar: true, orgId: ((_a = card === null || card === void 0 ? void 0 : card.organization) === null || _a === void 0 ? void 0 : _a.id) || ((_b = _card === null || _card === void 0 ? void 0 : _card.organization) === null || _b === void 0 ? void 0 : _b.id) || "" }) }, transaction.id));
                        ...
                        padding: 20,
                            ...
                            maxWidth: 400,
                                    ...
                                    fontFamily: "JetBrains Mono",
                                            ...
                                            borderRadius: 15,
                                            paddingVertical: 14,
                                        }, color: "white", onPress: handleTopup, loading: isToppingUp, disabled: !topupAmount || parseFloat(topupAmount) <= 0, children: "Topup" })] })] }) }) }), (0, jsx_runtime_1.jsx)(react_native_1.Modal, { visible: showPurposeModal, transparent: true, animationType: "fade", onRequestClose: function () { return setShowPurposeModal(false); }, children: (0, jsx_runtime_1.jsx)(react_native_1.View, { style: {
                        flex: 1,
                        backgroundColor: "rgba(0, 0, 0, 0.5)",
                        justifyContent: "center",
                        alignItems: "center",
                        padding: 20,
                            ...
                            maxWidth: 400,
                                    ...
                                    color: themeColors.text,
                                    marginBottom: 10,
                                }, children: "Set Grant Purpose" }), (0, jsx_runtime_1.jsx)(react_native_1.Text, { style: {
                                    fontSize: 16,
                                    color: themeColors.text,
                                    marginBottom: 8,
                                    fontWeight: "500",
                                }, children: "Purpose" }), (0, jsx_runtime_1.jsx)(react_native_1.TextInput, { style: {
                                    backgroundColor: "rgba(0, 0, 0, 0.05)",
                                    borderRadius: 8,
                                    padding: 12,
                                    fontSize: 16,
                                    ...
                                    textAlignVertical: "top",
                                }, placeholder: "Describe the purpose of this grant...", placeholderTextColor: themeColors.text + "80", multiline: true, numberOfLines: 4, value: purposeText, onChangeText: setPurposeText, autoFocus: true }), (0, jsx_runtime_1.jsxs)(react_native_1.View, { style: { flexDirection: "row", gap: 10 }, children: [(0, jsx_runtime_1.jsx)(Button_1.default, { style: {
                                            flex: 1,
                                            borderRadius: 15,
                                            backgroundColor: "rgba(0, 0, 0, 0.05)",
                                        }, color: themeColors.text, onPress: function () {
                                            ...
                                            borderRadius: 15,
                                            paddingVertical: 14,
                                        }, color: "#114F3D", onPress: handleSetPurpose, loading: isSettingPurpose, children: "Set Purpose" })] })] }) }) })] }));
}
