...
var CardListSkeleton_1 = __importDefault(require("../../components/cards/CardListSkeleton"));
var PaymentCard_1 = __importDefault(require("../../components/PaymentCard"));
var errorUtils_1 = require("../../lib/errorUtils");
var theme_1 = require("../../utils/theme");
var util_1 = require("../../utils/util");
var CardItem = (0, react_1.memo)(function (_a) {
...
function CardsPage(_a) {
    ...
    var combineCards = (0, react_1.useCallback)(function () {
        ...
        var transformedGrantCards = grantCards === null || grantCards === void 0 ? void 0 : grantCards.map(function (grantCard) { return (__assign(__assign({}, grantCard), { grant_id: grantCard.id, id: grantCard.card_id })); }).filter(function (grantCard) { return grantCard.card_id !== null; });
    ...
    if (sortedCards) {
        return ((0, jsx_runtime_1.jsx)(react_native_reorderable_list_1.default, { data: canceledCardsShown
                ...
                paddingTop: 20,
                alignItems: "center",
            }, scrollIndicatorInsets: { bottom: tabBarHeight }, onRefresh: onRefresh, refreshing: refreshing, renderItem: function (_a) {
                var _b, _c;
                var item = _a.item;
